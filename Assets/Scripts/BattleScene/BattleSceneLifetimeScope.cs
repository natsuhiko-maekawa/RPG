...
namespace BattleScene
{
    public class BattleSceneLifetimeScope : LifetimeScope
    {
        ...
        protected override void Configure(IContainerBuilder builder)
        {
            ...
            builder.Register<CureViewPresenter>(Lifetime.Singleton);
            ...
            builder.Register<CureOutput>(Lifetime.Singleton);
            ...
            builder.Register<ResetOutputFacade>(Lifetime.Singleton);
            ...
            builder.Register<EnemySelectActionState>(Lifetime.Singleton);
            ...
            builder.Register<PrimeSkillStartState<CureParameterValueObject>>(Lifetime.Singleton);
            ...
            builder.Register<PrimeSkillOutputState<CureParameterValueObject>, CureOutputState>(Lifetime.Singleton);
            ...
            builder.Register<PrimeSkillOutputState<DestroyParameterValueObject>, DestroyOutputState>(
                Lifetime.Singleton);
            builder.Register<PrimeSkillOutputState<ResetParameterValueObject>, ResetOutputState>(Lifetime.Singleton);
            ...
            builder.Register<PrimeSkillStopState<CureParameterValueObject>>(Lifetime.Singleton);
            ...
            builder.Register<EnemySelectActionUseCase>(Lifetime.Singleton);
            ...
            builder.Register<IPrimeSkillUseCase<CureParameterValueObject>,
                PrimeSkillUseCase<CureParameterValueObject>>(Lifetime.Singleton);
            ...
            builder.Register<IPrimeSkillUseCase<ResetParameterValueObject>, 
                PrimeSkillUseCase<ResetParameterValueObject>>(Lifetime.Singleton);
            ...
            builder.Register<InitializeEnemyUseCase>(Lifetime.Singleton);
            builder.Register<InitializePlayerUseCase>(Lifetime.Singleton);
            ...
            builder.Register<CureEvaluatorService>(Lifetime.Singleton);
            ...
            builder.Register<ITechnicalPointService, TechnicalPointService>(Lifetime.Singleton);
            ...
            builder.Register<IPrimeSkillService<CureParameterValueObject>, CureService>(Lifetime.Singleton);
