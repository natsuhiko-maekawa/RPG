...
namespace BattleScene.UseCase.Event
{
    internal class InitializationEvent : IEvent
    {
        ...
        public EventCode Run()
        {
            ...
            var skillSelector = new SkillSelectorAggregate(skillSelectorId, Constant.SelectSkillSlotNumber, skillNumber);
            ...
            var fatalitySkillSelector
                = new SkillSelectorAggregate(fatalitySkillSelectorId, Constant.SelectSkillSlotNumber, fatalitySkillNumber);
